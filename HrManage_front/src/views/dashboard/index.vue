    ...
    <div class="container">
      ...
      <div class="left">
        <div class="panel">
          <!-- 个人信息 -->
          <div class="user-info">
            <img class="avatar" src="../../assets/common/hl.jpg" alt="">
            <div class="company-info">
              <div class="title">
                上海花梨科技股份有限公司
                <span>体验版</span>
              </div>
              <div class="depart">{{ name }} ｜ 花梨科技-总裁办</div>
            </div>
          </div>
          <!-- 代办 -->
          <div class="todo-list">
        ...
        <div class="panel">
          ...
          <div class="information-list">
            <div class="information-list-item">
              ...
              <div>
                <p>
                  <span class="col">小花梨</span> 发布了
                  第1期“通海大讲堂”互动讨论获奖名单公布
                </p>
