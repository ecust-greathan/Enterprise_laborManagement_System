...
def updateUserPermissions():
    ...
    for emp in all_employees:
        ...
        # 去重获取权限的pid列表
        unique_perm_pids = list(set(all_perms_ids))
        ...
        # 更新员工的权限信息
        emp_info = userInfo.objects.get(mobile_num=emp.phone_num)
        emp_info.roles = permission_codes
        emp_info.save()
